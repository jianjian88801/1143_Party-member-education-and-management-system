    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="zhibuId" name="zhibuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="单位名称" prop="jicengdanweiName">
                       <el-input v-model="ruleForm.jicengdanweiName"
                                 placeholder="单位名称" clearable  :readonly="ro.jicengdanweiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="单位名称" prop="jicengdanweiName">
                           <el-input v-model="ruleForm.jicengdanweiName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系人" prop="jicengdanweiLianxiren">
                       <el-input v-model="ruleForm.jicengdanweiLianxiren"
                                 placeholder="联系人" clearable  :readonly="ro.jicengdanweiLianxiren"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="联系人" prop="jicengdanweiLianxiren">
                           <el-input v-model="ruleForm.jicengdanweiLianxiren"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系电话" prop="jicengdanweiPhone">
                       <el-input v-model="ruleForm.jicengdanweiPhone"
                                 placeholder="联系电话" clearable  :readonly="ro.jicengdanweiPhone"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="联系电话" prop="jicengdanweiPhone">
                           <el-input v-model="ruleForm.jicengdanweiPhone"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="单位类型" prop="jicengdanweiTypes">
                        <el-select v-model="ruleForm.jicengdanweiTypes" :disabled="ro.jicengdanweiTypes" placeholder="请选择单位类型">
                            <el-option
                                v-for="(item,index) in jicengdanweiTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="单位类型" prop="jicengdanweiValue">
                        <el-input v-model="ruleForm.jicengdanweiValue"
                            placeholder="单位类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="单位地址" prop="jicengdanweiAddress">
                       <el-input v-model="ruleForm.jicengdanweiAddress"
                                 placeholder="单位地址" clearable  :readonly="ro.jicengdanweiAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="单位地址" prop="jicengdanweiAddress">
                           <el-input v-model="ruleForm.jicengdanweiAddress"
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    zhibuId: false,
                    jicengdanweiName: false,
                    jicengdanweiLianxiren: false,
                    jicengdanweiPhone: false,
                    jicengdanweiTypes: false,
                    jicengdanweiAddress: false,
                },
                ruleForm: {
                    zhibuId: '',
                    jicengdanweiName: '',
                    jicengdanweiLianxiren: '',
                    jicengdanweiPhone: '',
                    jicengdanweiTypes: '',
                    jicengdanweiAddress: '',
                },
                jicengdanweiTypesOptions : [],
                zhibuOptions : [],
                rules: {
                   zhibuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jicengdanwei_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jicengdanweiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jicengdanwei/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jicengdanweiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
