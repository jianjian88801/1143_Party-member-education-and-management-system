    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">党员教育和管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="党员姓名" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="党员姓名"  />
                        </el-form-item>
                       <!--<el-form-item class="select" label="所在支部">
                            <el-select style="width: 300px" v-model="ruleForm.zhibuId" placeholder="请选择所在支部">
                                <el-option
                        ...
                        <el-form-item label="党员身份证号" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuIdNumber" autocomplete="off" placeholder="党员身份证号"  />
                        </el-form-item>
                        ...
                        <el-form-item label="负责人姓名" class="input" v-if="tableName=='zhibu'">
                            <el-input v-model="ruleForm.zhibuName" autocomplete="off" placeholder="负责人姓名"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='zhibu'">
                            <el-input v-model="ruleForm.zhibuPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='zhibu'">
                            <el-input v-model="ruleForm.zhibuEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            //// 党员 的 所在支部
                            // if((!this.ruleForm.zhibuId)&& 'yonghu'==this.tableName){
                            //     this.$message.error('所在支部不能为空');
                            //     return
                            // }
                            ...
                            if((!this.ruleForm.zhibuName)&& 'zhibu'==this.tableName){
                                this.$message.error('负责人姓名不能为空');
                                return
                            }
                             if('zhibu' == this.tableName && this.ruleForm.zhibuPhone&&(!this.$validate.isMobile(this.ruleForm.zhibuPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('zhibu' == this.tableName && this.ruleForm.zhibuEmail&&(!this.$validate.isEmail(this.ruleForm.zhibuEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                this.$http({
