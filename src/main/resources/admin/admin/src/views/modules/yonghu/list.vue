            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '党员姓名' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.yonghuName" placeholder="党员姓名" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/dangyuanjiaoyuguanli/upload/yonghuMuBan.xls"
                        >批量导入党员数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yonghu','导入导出')"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '工作职务': "gongzuozhiwu",
                     '入党时间': "rudangshijian",
                     '转正时间': "zhuanzhengshijian",
                     '签发日期': "qianfariqi",
                     '联系方式': "yonghuPhone",
                     '党员身份证号': "yonghuIdNumber",
                     '邮箱': "yonghuEmail",
            },
