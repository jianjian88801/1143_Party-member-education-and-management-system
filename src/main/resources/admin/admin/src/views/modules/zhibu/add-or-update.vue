               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="负责人姓名" prop="zhibuName">
                       <el-input v-model="ruleForm.zhibuName"
                                 placeholder="负责人姓名" clearable  :readonly="ro.zhibuName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="党支部" prop="zhibuDangzhibu">
                       <el-input v-model="ruleForm.zhibuDangzhibu"
                                 placeholder="党支部" clearable  :readonly="ro.zhibuDangzhibu"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="zhibuPhone">
                       <el-input v-model="ruleForm.zhibuPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.zhibuPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="办公地址" prop="zhibuAddress">
                       <el-input v-model="ruleForm.zhibuAddress"
                                 placeholder="办公地址" clearable  :readonly="ro.zhibuAddress"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="zhibuEmail">
                       <el-input v-model="ruleForm.zhibuEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.zhibuEmail"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="支部详情" prop="zhibuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.zhibuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhibuContent" label="支部详情" prop="zhibuContent">
                            <span v-html="ruleForm.zhibuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   zhibuContent: [
                              { required: true, message: '支部详情不能为空', trigger: 'blur' },
                          ],
                   zhibuDelete: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`zhibu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.zhibuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
