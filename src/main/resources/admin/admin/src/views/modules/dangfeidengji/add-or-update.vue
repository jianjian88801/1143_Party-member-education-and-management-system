    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="zhibuId" name="zhibuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="缴纳金额" prop="dangfeidengjiName">
                       <el-input v-model="ruleForm.dangfeidengjiName"
                                 placeholder="缴纳金额" clearable  :readonly="ro.dangfeidengjiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="缴纳金额" prop="dangfeidengjiName">
                           <el-input v-model="ruleForm.dangfeidengjiName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否支付" prop="dangfeidengjiTypes">
                        <el-select v-model="ruleForm.dangfeidengjiTypes" :disabled="ro.dangfeidengjiTypes" placeholder="请选择是否支付">
                            <el-option
                                v-for="(item,index) in dangfeidengjiTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="是否支付" prop="dangfeidengjiValue">
                        <el-input v-model="ruleForm.dangfeidengjiValue"
                            placeholder="是否支付" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="登记日期" prop="dangfeidengjiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.dangfeidengjiTime"
                                type="datetime"
                                placeholder="登记日期"
                                :disabled="ro.dangfeidengjiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.dangfeidengjiTime" label="登记日期" prop="dangfeidengjiTime">
                            <span v-html="ruleForm.dangfeidengjiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    zhibuId: false,
                    dangfeidengjiName: false,
                    dangfeidengjiTypes: false,
                    dangfeidengjiTime: false,
                },
                ruleForm: {
                    zhibuId: '',
                    dangfeidengjiName: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=dangfeidengji_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.dangfeidengjiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`dangfeidengji/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.dangfeidengjiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
