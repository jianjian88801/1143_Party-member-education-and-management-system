...
public class ZhiburizhiView extends ZhiburizhiEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 日志类型的值
		*/
		private String zhiburizhiValue;
	...
	public ZhiburizhiView(ZhiburizhiEntity zhiburizhiEntity) {
		try {
			...
			* 获取： 日志类型的值
			*/
			public String getZhiburizhiValue() {
				return zhiburizhiValue;
			}
			/**
			* 设置： 日志类型的值
			*/
			public void setZhiburizhiValue(String zhiburizhiValue) {
				this.zhiburizhiValue = zhiburizhiValue;
			}
