...
public class JicengdanweiView extends JicengdanweiEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 单位类型的值
		*/
		private String jicengdanweiValue;
	...
	public JicengdanweiView(JicengdanweiEntity jicengdanweiEntity) {
		try {
			...
			* 获取： 单位类型的值
			*/
			public String getJicengdanweiValue() {
				return jicengdanweiValue;
			}
			/**
			* 设置： 单位类型的值
			*/
			public void setJicengdanweiValue(String jicengdanweiValue) {
				this.jicengdanweiValue = jicengdanweiValue;
			}
