...
public class DangfeidengjiView extends DangfeidengjiEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 是否支付的值
		*/
		private String dangfeidengjiValue;
	...
	public DangfeidengjiView(DangfeidengjiEntity dangfeidengjiEntity) {
		try {
			...
			* 获取： 是否支付的值
			*/
			public String getDangfeidengjiValue() {
				return dangfeidengjiValue;
			}
			/**
			* 设置： 是否支付的值
			*/
			public void setDangfeidengjiValue(String dangfeidengjiValue) {
				this.dangfeidengjiValue = dangfeidengjiValue;
			}
