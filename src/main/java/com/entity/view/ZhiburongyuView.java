...
public class ZhiburongyuView extends ZhiburongyuEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 荣誉类型的值
		*/
		private String zhiburongyuValue;
	...
	public ZhiburongyuView(ZhiburongyuEntity zhiburongyuEntity) {
		try {
			...
			* 获取： 荣誉类型的值
			*/
			public String getZhiburongyuValue() {
				return zhiburongyuValue;
			}
			/**
			* 设置： 荣誉类型的值
			*/
			public void setZhiburongyuValue(String zhiburongyuValue) {
				this.zhiburongyuValue = zhiburongyuValue;
			}
